...
//ejecutar las promesas retonrnando la mas rapida unicamente, sirve para saer q proceso es el mas rapido para retornar
//puedo mandar lo q sea en el arreglo
let arreglo = [sumarLento(5), sumarRapido(6)];
//Promise.all(arreglo).then(console.log);
//o funcion flecha con el retorno
Promise.race(arreglo).then(respuestas => {
